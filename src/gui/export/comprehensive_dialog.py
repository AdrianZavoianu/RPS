...
from .workers import ComprehensiveExportWorker
...
class ComprehensiveExportDialog(QDialog):
    ...
    def __init__(self, context, result_service, current_result_set_id,
        ...
        from gui.export import dialogs as dialogs_module
        self.discovery_service = dialogs_module.ExportDiscoveryService(self.context.session)
