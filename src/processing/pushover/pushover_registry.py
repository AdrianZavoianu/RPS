...
class PushoverRegistry:
    ...
    ELEMENT_TYPES = frozenset({"wall", "beam", "column", "column_shear", "brace"})
    ...
    _IMPORTER_MAP: Dict[str, tuple[str, str]] = {
        ...
        "brace": ("pushover_brace_importer", "PushoverBraceImporter"),
        "soil_pressure": ("pushover_soil_pressure_importer", "PushoverSoilPressureImporter"),
        "vert_displacement": (
            "pushover_vert_displacement_importer",
    ...
    _PARSER_MAP: Dict[str, tuple[str, str]] = {
        ...
        "brace": ("pushover_brace_parser", "PushoverBraceParser"),
        "soil_pressure": ("pushover_soil_pressure_parser", "PushoverSoilPressureParser"),
        "vert_displacement": (
            "pushover_vert_displacement_parser",
            "PushoverVertDisplacementParser",
        ),
