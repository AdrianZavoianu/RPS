"""Standardized error handling utilities for worker threads and UI components.

This module provides consistent error handling patterns that:
1. Log errors with structured context
2. Format user-friendly error messages
3. Support both background workers and UI components
