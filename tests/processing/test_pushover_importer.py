...
from processing.pushover_parser import PushoverCurveData
...
class TestPushoverImporterInit:
    ...
    def test_creates_repositories(self):
        ...
        with patch('processing.pushover_importer.ProjectRepository'):
            with patch('processing.pushover_importer.ResultSetRepository'):
...
class TestGetOrCreateResultSet:
    ...
    def test_creates_new_result_set(self):
        ...
        with patch('processing.pushover_importer.ProjectRepository'):
            with patch('processing.pushover_importer.ResultSetRepository') as MockRepo:
    ...
    def test_filters_by_direction(self):
        ...
        with patch('processing.pushover_importer.ProjectRepository'):
            with patch('processing.pushover_importer.ResultSetRepository') as MockRepo:
                ...
                with patch('processing.pushover_importer.PushoverParser') as MockParser:
                    mock_parser = MockParser.return_value
                    mock_parser.parse_curves.return_value = all_curves

                    with patch('processing.pushover_importer.PushoverTransformer') as MockTransformer:
